...
export default defineConfig({
  ...
  /**
   * Linux CI machines are our source of truth for screenshots, so if running locally, make the
   * threshold maximally lax to avoid false negatives by default on e.g. macOS.
   *
   * For local debugging of screenshots, naturally this section can be temporarily commented out.
   */
  expect: isCI
    ? undefined
    : {
